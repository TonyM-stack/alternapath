...
// export const metadata = { title: "Login • Alternapath" };
...
return (
    <>
     ...
     <main className="mt-16 mx-auto max-w-md p-6">
      <BackLink label="← Back" />
      <h1 className="text-3xl mt-8 text-blue-400 font-semibold">Login</h1>
    ...
    <div className="space-y-1">
      ...
      <input
        ...
        className="w-full rounded border border-slate-300 bg-white p-2 focus:border-green-500 focus:ring-1 
    ...
    <div className="space-y-1">
      ...
      <div className="relative">
        <input
          id="password"
          name="password"
          className="w-full rounded border p-2 border-slate-300 bg-white focus:border-green-500
    ...
    <button className="rounded-lg bg-green-600 hover:bg-green-700 px-4 py-2 text-lg font-medium text-white">
      Submit
    </button>
  </form>
      <p className="text-sm text-blue-700 mt-8">*You must be Logged In to create or see your Favorites List</p>
</main>
  </>
 );
}
